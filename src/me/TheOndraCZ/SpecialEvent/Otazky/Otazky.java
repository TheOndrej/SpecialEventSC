...
public class Otazky implements CommandExecutor{

    private HashMap<Integer, Boolean> pouziti = new HashMap<>();

    public void onGui(Player p){


        ArrayList<ItemStack> meta = new ArrayList<>();
        Inventory inv = Bukkit.createInventory(null, 54, "§4§lOtázky §7strana 1");
        ...
        for (int in = 0; in <= 42; in++){
           ...
           if (in%2 == 0){
               if (in <= 12){
                   ...
                   stacklore.add("§7Znění otázky zjistíte pravým kliknutím.");
                   if (Main.getOtazky().pouziti.get(in) == true){
                       stacklore.add("§7Použito: §aAno");
                   } else {
                       stacklore.add("§7Použito: §4Ne");
                   }
                   ...
                   stacklore.add("§7Otázka za: §63 bodů");
                   stackmeta.setLore(stacklore);
                   stack.setItemMeta(stackmeta);
    ...
    public void onGuia(Player p){
        ...
        ItemStack stackl = new ItemStack(Material.STAINED_GLASS_PANE);
        Inventory inv2 = Bukkit.createInventory(null, 54, "§4§lOtázky §7strana 2");
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String s, String[] args) {
        if (cmd.getName().equalsIgnoreCase("otazky")){
    ...
    public HashMap<Integer, Boolean> getPouziti() {
        return pouziti;
    }
}
